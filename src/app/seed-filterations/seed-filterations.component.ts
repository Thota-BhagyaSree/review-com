...
@Component({
  selector: 'app-seed-filterations',
  templateUrl: './seed-filterations.component.html',
  styleUrls: ['./seed-filterations.component.css']
})
export class SeedFilterationsComponent {
  allSeeds: SeedDto[] = [];
