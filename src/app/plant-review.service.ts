...
export class PlantReviewService {
  getAllReviewByPlantId(plant: number) {
  ...
  //  getRatingsByPlantId(filterReviewbyrating:number):Observable<PlantReview>
  //  {
  ...
  //  }
   getAllReviewsByPlantId(plantId:number):Observable<PlantReviewDTO[]>{
